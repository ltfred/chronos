...
func main() {
	//day := models.NewDay(2025, 1)
	day := models.NewMonthModel(2025)

	p := tea.NewProgram(day)
...
func (m mainModel) View() string {
	...
	s += lipgloss.JoinHorizontal(lipgloss.Top, focusedModelStyle.Render("1234"), modelStyle.Render("5678"))
	return s
}
